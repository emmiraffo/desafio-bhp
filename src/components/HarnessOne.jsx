    ...
    <div className="container"> 
      ...
      <div class="accordion accordion-flush" id="accordionFlushExample">
        ...
        <div className="harnessInfo">
          <div>
            <img className="imgInfo" src="https://bbrtreck.s3-sa-east-1.amazonaws.com/images/product/09-02-008-F1-1300.jpg" alt="arnes" width="150px" />
          </div>
          <div>
            <p className="info">Arnés para trabajos relacionados con el manejo de cargas de tensión y arco eléctrico. 
