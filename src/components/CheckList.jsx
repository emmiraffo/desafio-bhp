...
const CheckList = () => {
    ...
    return (
        <div className="check-container">
            ...
            <form onSubmit={enviar} id="Myform" className="p-1">
                <label className="me-1">Nombre trabajador</label>
                <input type="text"/>        
                <h5>Estado del arnés</h5>
                <div className="form-check" >
                    <input className="form-check-input my-2" type="checkbox" name="check" />
